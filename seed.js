...
db.Ride.remove({}, function(err, rides){
  if(err) {
    console.log('Error occurred in remove', err);
  } else {
    console.log('removed all rides');

    // create new records based on the array rides_list
    db.Ride.create(rides_list, function(err, rides){
